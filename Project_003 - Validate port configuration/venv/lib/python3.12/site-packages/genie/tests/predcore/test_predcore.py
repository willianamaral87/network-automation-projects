...
class TestPredicatePrerequisite(unittest.TestCase):
    ...
    def call_lists_are_equal(list1, list2):
        ...
        for item1,item2 in zip(list1, list2):
            ...
            if ('call.sleep' in str1) and ('call.sleep' in str2):
                ...
                #
                m1 = re.match(r'call\.sleep\(([0-9\.]+)\)', str1)
                m2 = re.match(r'call\.sleep\(([0-9\.]+)\)', str2)
                if      m1 and m2 and \
    ...
    def setUp(self):
        ...
        self.dictEqualDumpExpectedOutputPattern1 = r"AreNotEqual : \(\nItemsInActualButNotInExpected : \['key3'\], \nItemsInExpectedButNotInActual : \['key4'\]\)"

        self.dictEqualDumpExpectedOutputPattern2 = r"AreNotEqual : \(\nItemsInActualButNotInExpected : \['key4'\]\)"

        self.dictEqualDumpExpectedOutputPattern3 = r"AreNotEqual : \(\nItemsInExpectedButNotInActual : \['key4'\]\)"

        self.dictEqualDumpExpectedOutputPattern4 = r"AreNotEqual : \(\nUnexpectedValue \(Item key2 has value value2actual \(expected value2bad\)\)\)"

        self.dictEqualDumpExpectedOutputPattern5 = r"AreNotEqual : \(\nItemsInActualButNotInExpected : \['key4'\], \nItemsInExpectedButNotInActual : \['key5'\], \nUnexpectedValue \(Item key2 has value value2actual \(expected value2bad\)\)\)"
